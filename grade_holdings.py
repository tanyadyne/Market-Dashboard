...
ETF_INFO = [
    ...
    {"t":"AMLP","h":"WES,PAA,SUN,ET,EPD,MPLX,HESM,CQP,USAC,GEL,SPH,GLP,DKL"},
    ...
    {"t":"UFO","h":"RKLB,PL,VSAT,IRDM,FLY,SIRI,GSAT,LUNR,ASTS,SATS,GRMN,TRMB,VOYG,BA,HON,RTX,LHX,BKSY,LMT,RDW,NOC,SATL,GILT,CMCSA,SPIR,KRMN,SIDU"},
    ...
    {"t":"ARKW","h":"AMD,TSLA,HOOD,CRCL,ROKU,SHOP,AMZN,GOOG,CRWV,COIN,XYZ,PLTR,CRWD,RBLX,DDOG,AVGO,TSM,META,NET,BLSH,P,BMNR,RBRK,FIG,NFLX,SPOT,NVDA,GTLB,BABA,TOST,GENI,CBRS,BIDU,DKNG,DASH,MELI,ABNB,SLMT"},
    ...
    {"t":"XSD","h":"MU,INTC,RGTI,AMD,MRVL,MTSI,FSLR,RMBS,SITM,SMTC,MPWR,ADI,QCOM,CRUS,ON,AVGO,CRDO,LSCC,NVDA,QRVO,SLAB,TXN,NXPI,SWKS,OLED,TSEM,TSM,AMAT,ASML,LRCX,KLAC,CDNS,SNPS,TER,MCHP,STM"},
    ...
    {"t":"GRID","h":"ETN,JCI,PWR,NVT,HUBB,NVDA,TSLA,CSCO,ORCL,APTV,TXN,GEV,QCOM,IBM,ADI,ENPH,MYRG,HON"},
    ...
    {"t":"SOCL","h":"META,RDDT,GOOGL,BIDU,NTES,SPOT,PINS,MTCH,SNAP,BILI,TME,IAC,JOYY,YELP,DJT,RUM,WB,MOMO,CXM,NXDR,GRPN,GRND,SPT,FVRR,BMBL"},
    ...
    {"t":"EUV","h":"TSM,ASML,LRCX,GLW,AMAT,CIEN,LITE,KLAC,COHR,MTSI,AXTI,CRDO,MRVL,FN,NVMI,ENTG,AAOI,VIAV,NOVT,ONTO,LASR,FORM,OUST,VECO,AEVA,UCTT,HSAI,PLAB,IPGP,CAMT,AEHR,PDFS,POET,ADTN,TDY,TSEM,GFS,LWLG,MTRN"},
