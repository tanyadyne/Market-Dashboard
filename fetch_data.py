...
ETF_INFO = [
    ...
    {"t":"XHE","n":"Healthcare Equipment","fn":"SS SPDR S&P Hlth Care Eq","h":"ABT,ALGN,AXGN,BAX,BDX,BFLY,COO,EW,GEHC,GKOS,GMED,ICUI,IDXX,INSP,IRTC,ITGR,LIVN,LNTH,MDLN,MDT,MMSI,NVST,PODD,RMD,STE,SYK,TMDX,UFPT,XRAY,ZBH"},
    {"t":"XLV","n":"Healthcare","fn":"Sel Sector:HC SS SPDR","h":"LLY,UNH,ABBV,JNJ,MRK,ABT,PFE,AMGN,GILD,TMO,VRTX,ISRG,MCK,CVS,SYK,BSX,BMY,MDT,DHR,REGN,ELV,HCA,HUM,ZTS,CAH,BDX,COR,CI,EW,VEEV,IDXX,CNC,WAT,DXCM,GEHC,RMD,IQV,A,WST,MTD,BIIB"},
    ...
    {"t":"XPH","n":"Pharmaceuticals","fn":"SS SPDR S&P Pharm","h":"LLY,ABBV,JNJ,MRK,VRTX,BMY,NVO,AXSM,ASND,MDGL,BIIB,DFTX,ROIV,PTCT,INCY,CYTK,LQDA,RPRX,PRAX,SYRE,LGND,JAZZ,TGTX,VTRS,IONS,EXEL,RGEN,ALKS,ORKA,MIRM,TVTX,ELVN,RYTM,ELAN,PTGX,XENE,MANE,IBRX,VKTX,RARE,LEGN,ERAS,CORT,SLS,INDV,EWTX,KNSA,BHVN,ARQT,NUVB,IDYA,ATAI,MBX,TRVI,AGIO,TARS"},
    ...
    {"t":"ARKG","n":"Genomics","fn":"ARK Genomic Revolution","h":"ABSI,ADPT,ARWR,ATAI,AZN,BEAM,BFLY,BLLN,BMRN,BMY,BNTX,BRKR,CAI,CRSP,DHR,GH,GILD,ILMN,IONS,LEGN,LLY,MRNA,NRIX,NTLA,NTRA,PRAX,PSNL,QGEN,QURE,RARE,RXRX,SRPT,TECH,TEM,TWST,TXG,VCYT,VRTX,WGS"},
    {"t":"GBTC","n":"Bitcoin","fn":"GRAYSCALE BITCOIN TRUST","h":"IBIT,ETHA,MSTR,BMNR,SBET,COIN"},
    {"t":"IGV","n":"Software","fn":"iShares:Expand Tch-Sftwr","h":"MSFT,PLTR,ORCL,CRM,APP,NOW,ADBE,PANW,CRWD,INTU,DDOG,SNPS,FTNT,CDNS,TTWO,ADSK,WULF,WDAY,ZS,PATH,ROP,TEAM,FICO,ZM,HUBS,BB,RBRK,GWRE,DT,FRSH,DOCU,IOT,ZETA,AUR,GEN,NTNX,U,PCOR,TTAN,TDC,BSY,CVLT,GTLB,ESTC,DBX,VRNS,KVYO,QLYS,BILL,MANH,PEGA,S,TENB,ADEA,APPF,BOX,RNG,SPSC,WK,FIVN,OTEX,ACIW,DLB,NN,BRZE,ATEN"},
    ...
    {"t":"CIBR","n":"Cybersecurity","fn":"FT II:Nsdq Cybersecurity","h":"CSCO,IBM,PANW,CRWD,DDOG,FTNT,NET,ZS,NTAP,AKAM,OKTA,FROG,BB,INFY,RBRK,LDOS,DT,FFIV,GEN,CHKP,CVLT,ESTC,VRNS,FSLY,QLYS,S,TENB,ATEN"},
    ...
    {"t":"NURS","n":"Medical/Nursing Services","fn":"Custom Basket","h":"LH,FMS,ENSG,SOLV,GH,EHC,DVA,BTSG,RDNT,OPCH,HIMS,BLLN,CON,LFST,WGS","d":"This custom basket tracks companies tied to healthcare delivery, diagnostics, patient services, nursing care, dialysis, home health, and medical support infrastructure. It is designed to represent businesses that benefit from rising healthcare utilization, outsourced care delivery, and demand for clinical services across hospitals, outpatient networks, and home-based care.","basket":True},
    {"t":"CHEMG","n":"Chemicals (Agricultural)","fn":"Custom Basket","h":"NTR,CF,MOS,ICL,SMG,FMC,UAN,LXU","d":"This custom basket tracks companies involved in agricultural chemicals, crop nutrients, fertilizers, and related inputs used in food production. It is designed to represent the agriculture chemical supply chain, including nitrogen, phosphate, potash, and specialty crop-treatment exposure.","basket":True},
    {"t":"CHEMS","n":"Chemicals (Specialty)","fn":"Custom Basket","h":"LIN,ECL,APD,DOW,LYB,ALB,SQM,WLK,EMN,NEU,CE,MEOH,CBT,HWKN,CC,KWR,GEL,MTX,ROG,SHW,DD,SOLS,OLN,AXTA","d":"This custom basket tracks specialty chemical companies serving industrial, materials, coatings, refining, electronics, energy, and consumer end markets. It is designed to represent higher-value chemical production and formulation businesses where performance is driven by pricing power, process expertise, and demand across diversified industrial applications.","basket":True},
    {"t":"QNTM","n":"Quantum","fn":"Custom Basket","h":"SKYT,ARQQ,QSI,QUBT,QBTS,RGTI,IONQ","d":"This custom basket tracks companies with exposure to quantum computing hardware, quantum software, enabling infrastructure, and adjacent advanced computing technologies. It is designed to represent early-stage commercial development in quantum systems, cloud-accessible quantum platforms, and specialized components needed for next-generation computing.","basket":True},
    {"t":"COOL","n":"HVAC / Cooling","fn":"Custom Basket","h":"FIX,EME,JCI,TT,WSO,VRT,CARR,LII,SPXC,AAON","d":"This custom basket tracks companies tied to heating, ventilation, air conditioning, electrical contracting, thermal management, and cooling infrastructure. It is designed to represent demand from building systems, industrial cooling, data center thermal management, electrification, and efficiency upgrades.","basket":True},
    {"t":"AGENT","n":"Agentic AI","fn":"Custom Basket","h":"GTLB,ASAN,PATH,BRZE,VERI,AI,SOUN,BBAI,LAW,CRNC","d":"This custom basket tracks software and AI infrastructure companies associated with workflow automation, enterprise copilots, voice AI, autonomous task execution, and AI-enabled business operations. It is designed to represent companies positioned around agentic AI adoption, where software systems can increasingly act, automate, and coordinate work on behalf of users.","basket":True},
    {"t":"OPTIC","n":"Photonics","fn":"Custom Basket","h":"LITE,COHR,AAOI,POET,ALMU,LWLG,MTSI,GLW,FN,GFS,TSEM,LRCX,CIEN,AXTI,NVMI,IPGP","d":"This custom basket tracks companies involved in optical networking, lasers, photonic components, fiber infrastructure, semiconductor equipment, and advanced optical manufacturing. It is designed to represent the photonics supply chain supporting data centers, telecom networks, high-speed connectivity, precision manufacturing, and optical semiconductor applications.","basket":True},
