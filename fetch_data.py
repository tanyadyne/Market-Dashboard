...
from vcp_coils import (
    ...
    compute_vcp_coil_definition_1_score as compute_vcp_tightness_score,
)
...
ETF_INFO = [
    ...
    {"t":"KIE","n":"Insurance","fn":"SS SPDR S&P Insurance","h":"LMND,BHF,MCY,WTM,RYAN,ORI,L,RNR,AGO,CINF,MKL,AIZ,TRV,CB,PFG,AXS,ALL,THG,CNO,HIG,PLMR,ACGL,PRU,AFL,UNM,PGR,AJG,BRO,OSCR,KNSL,FAF,RGA,BWIN,ERIE,RLI,SKWD"},
